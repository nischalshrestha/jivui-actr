(function() {
  ...
  var EyePathRenderer = {
    ...
    canvas: null,
    ctx: null,
    style: "red", // changed from black to make trail visible for concentration grid which has a black background
    size: 5, // increased from 1 for visibility
    length: 100, // increased from 1 for visibility
